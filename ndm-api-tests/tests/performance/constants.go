...
func init() {
	...
	JOB_SERVICE_URL = os.Getenv("AZ_JOB_SERVICE_URL")
	CONFIG_SERVICE_URL = os.Getenv("AZ_CONFIG_SERVICE_URL")
	ADMIN_SERVICE_URL = os.Getenv("AZ_ADMIN_SERVICE_URL")
	REPORT_SERVICE_URL = os.Getenv("AZ_REPORT_SERVICE_URL")
	KEYCLOAK_IP = os.Getenv("AZ_KEYCLOAK_IP")
	USERNAME = os.Getenv("AZ_NDM_USERNAME")
	PASSWORD = os.Getenv("AZ_NDM_PASSWORD")
	NDM_VM_USER_NAME = os.Getenv("AZ_NDM_VM_USER_NAME")
	NDM_VM_HOST = os.Getenv("AZ_NDM_VM_HOST")
	NDM_VM_PORT = os.Getenv("AZ_NDM_VM_PORT")
	NDM_VM_PASSWORD = os.Getenv("AZ_NDM_VM_PASSWORD")
	NDM_WORKERS_USER_NAME = os.Getenv("AZ_NDM_WORKERS_USER_NAME")
	NDM_WORKERS_HOST = os.Getenv("AZ_NDM_WORKERS_HOST")
	NDM_WORKERS_PORT = os.Getenv("AZ_NDM_WORKERS_PORT")
	NDM_WORKERS_PASSWORD = os.Getenv("AZ_NDM_WORKERS_PASSWORD")
	SOURCE_HOST_IP = os.Getenv("AZ_SOURCE_HOST_IP")
	DESTINATION_HOST_IP = os.Getenv("AZ_DESTINATION_HOST_IP")
}

...
#run_tests "download-error-report-regression" "./tests/download-error-report-regression" "./tests/download-error-report-e2e" "vSphere" "NFS"


#Download-Error-Report-End-to-End Testing
#run_tests "download-error-report-e2e" "./tests/download-error-report-e2e" "vSphere" "NFS"

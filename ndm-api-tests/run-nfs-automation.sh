...
#End-to-End Testing
run_tests "end-to-end" "./tests/e2e" "volSrcAuto, vol_src_automation2, vol_src_automation"  "vol_dest_automation, vol_dest_automation2" "NFS"


#Smoke Testing
run_tests "smoke" "./tests/smoke" "volSrcAuto, vol_src_automation2, vol_src_automation"  "vol_dest_automation, vol_dest_automation2"  "NFS"


#Download-Error-Report-Regression Testing
#run_tests "download-error-report-regression" "./tests/download-error-report-regression" "./tests/download-error-report-e2e" "volSrcAuto, vol_src_automation2, vol_src_automation"  "vol_dest_automation, vol_dest_automation2" "NFS"


#Download-Error-Report-End-to-End Testing
#run_tests "download-error-report-e2e" "./tests/download-error-report-e2e" "volSrcAuto, vol_src_automation2, vol_src_automation"  "vol_dest_automation, vol_dest_automation2" "NFS"

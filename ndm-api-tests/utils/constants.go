...
func UpdateConfVariables(protocolType, environment string) {
	...
	case AWSEnv:
		switch PROTOCOL_TYPE {
		case ProtocolNFS:
			NDM_WORKERS_HOST = AWS_NFS_NDM_WORKERS_HOST
			NDM_WORKERS_USER_NAME = AWS_NFS_NDM_WORKERS_USER_NAME
			NDM_WORKERS_PORT = AWS_NFS_NDM_WORKERS_PORT
			NDM_WORKERS_PASSWORD = AWS_NFS_NDM_WORKERS_PASSWORD
		case ProtocolSMB:
			NDM_WORKERS_HOST = AWS_SMB_NDM_WORKERS_HOST
			NDM_WORKERS_USER_NAME = AWS_SMB_NDM_WORKERS_USER_NAME
			NDM_WORKERS_PORT = AWS_SMB_NDM_WORKERS_PORT
			NDM_WORKERS_PASSWORD = AWS_SMB_NDM_WORKERS_PASSWORD
		}
	case vSphereEnv:
		switch PROTOCOL_TYPE {
		case ProtocolNFS:
	...
	case VolumeCloneProviderFSxN:
		switch PROTOCOL_TYPE {
		case ProtocolNFS:
			SOURCE_VOLUMES_LIST = AWS_FSXN_NFS_SOURCE_VOLUMES
			DESTINATION_VOLUMES_LIST = AWS_FSXN_NFS_DEST_VOLUMES
			SOURCE_HOST_IP = AWS_FSXN_NFS_SRC_HOST_IP
			DESTINATION_HOST_IP = AWS_FSXN_NFS_DST_HOST_IP
		case ProtocolSMB:
			SOURCE_VOLUMES_LIST = AWS_FSXN_SMB_SOURCE_VOLUMES
			DESTINATION_VOLUMES_LIST = AWS_FSXN_SMB_DEST_VOLUMES
			SOURCE_HOST_IP = AWS_FSXN_SMB_SRC_HOST_IP
			DESTINATION_HOST_IP = AWS_FSXN_SMB_DST_HOST_IP
		}
	...
	case ProtocolNFS:
		...
		case AWSEnv:
			PROTOCOL_USERNAME = AWS_NFS_PROTOCOL_USERNAME
			PROTOCOL_PASSWORD = AWS_NFS_PROTOCOL_PASSWORD
		case vSphereEnv:
	...
	case ProtocolSMB:
		...
		case AWSEnv:
			PROTOCOL_USERNAME = AWS_SMB_PROTOCOL_USERNAME
			PROTOCOL_PASSWORD = AWS_SMB_PROTOCOL_PASSWORD
			PROTOCOL_DOMAIN_NAME = AWS_SMB_DOMAIN_NAME
		case vSphereEnv:
			PROTOCOL_USERNAME = os.Getenv("VSPHERE_SMB_PROTOCOL_USERNAME")
			PROTOCOL_PASSWORD = os.Getenv("VSPHERE_SMB_PROTOCOL_PASSWORD")
			PROTOCOL_DOMAIN_NAME = os.Getenv("VSPHERE_SMB_DOMAIN_NAME")
		}

import { IsArray, ArrayNotEmpty, IsString, ValidateNested, IsNotEmpty, IsOptional, ValidateIf, ValidatorConstraint, ValidatorConstraintInterface, ValidationArguments, Validate, IsUUID } from 'class-validator';

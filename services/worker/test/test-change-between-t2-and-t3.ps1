# test-change-between-t2-and-t3.ps1
# Simulates a single external ACL change on source between T2 and T3.
...
#
# Expected result:
#   Attempt 1: T3 > T2 → conflict detected (changedAfterPreserveTimeAtSource=true)
#   Attempt 2: no change → stamp succeeds with kiran Write on destination
#
# Usage:
#   powershell -ExecutionPolicy Bypass -File test-change-between-t2-and-t3.ps1 `

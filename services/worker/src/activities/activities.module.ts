...
import { SecurityDescriptorChangeDetectorService } from './core/migrate/command-execution/win-opeartions/security-descriptor-change-detector.service';
...
import { DeferredDirStampService } from './core/shared/deferred-dir-stamp.service';
import { RestampDirectoriesService } from './core/migrate/restamp-directories.service';
import { CtimeTestTriggersService } from './core/migrate/ctime-test-triggers.service';
...
@Module({
  ...
  controllers: [],
  providers: [ValidateConnectionActivity, ListPathActivity,  RedisService,  SetupActivityService, FileTypeDetectionService, MigrateScanService, ValidateWorkingDirectoryActivity,PrecheckActivity, CommonActivityService, SpeedTestActivities, RedisMemoryCheckActivity,  CommonTaskService, DiscoveryScanService, ScanService, SyncService, CommandExecService, StampMetaService, ValidatePathActivity, WinShellService, WinOperationService, SecurityDescriptorChangeDetectorService, MappingResolverService, SetupExportsPathPermissionService, StorageClientFactory, FetchFailedOperationsActivity, ProcessRetryBatchActivity, CommandGenerationService, DirStreamingService, DeferredDirStampService, RestampDirectoriesService, CtimeTestTriggersService],
  exports:  [ValidateConnectionActivity, ListPathActivity,  RedisService,  SetupActivityService,  FileTypeDetectionService, MigrateScanService,  ValidateWorkingDirectoryActivity,PrecheckActivity, CommonActivityService, SpeedTestActivities,RedisMemoryCheckActivity, CommonTaskService, DiscoveryScanService, ScanService, SyncService, CommandExecService, StampMetaService, ValidatePathActivity, WinShellService, WinOperationService, SecurityDescriptorChangeDetectorService, MappingResolverService, SetupExportsPathPermissionService, StorageClientFactory, FetchFailedOperationsActivity, ProcessRetryBatchActivity, CommandGenerationService, UpgradeActivityModule, DirStreamingService, DeferredDirStampService, RestampDirectoriesService, CtimeTestTriggersService],
})

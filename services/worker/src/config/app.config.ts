...
export default registerAs(
  ...
  (): ConfigObject => ({
    ...
    maxScanConcurrency: parseInt(process.env.MAX_SCAN_CONCURRENCY || '10'),
    scanBatchSize: parseInt(process.env.MAX_SCAN_BATCH_SIZE || '100'),
    ...
    maxDiscoveryFileStreamLen: parseInt(process.env.MAX_DISCOVERY_FILE_STREAM_LEN || '200000'),

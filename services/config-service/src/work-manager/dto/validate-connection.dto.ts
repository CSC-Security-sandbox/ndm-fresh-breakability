...
export class Options {
  @ApiProperty({ description: 'Timeout for workflow execution', default: '90s', required: false })
  @IsOptional()
  @IsString()
  workflowExecutionTimeout: string = '90s';

  @ApiProperty({ description: 'Timeout for workflow task', default: '60s', required: false })
  @IsOptional()
  @IsString()
  workflowTaskTimeout: string = '60s';

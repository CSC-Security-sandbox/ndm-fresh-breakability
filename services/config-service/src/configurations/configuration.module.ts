...
@Module({
    imports: [
        ...
        TypeOrmModule.forFeature([WorkerEntity, VolumeEntity, FileServerEntity, ConfigEntity, FileServerWorkingDirectoryMappingEntity, ProjectEntity, WorkerStatsEntity, JobConfigEntity]),
        AuthKeycloakModule,
        WorkflowModule
    ],

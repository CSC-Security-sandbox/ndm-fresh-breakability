        ...
        <Box>
          <NumberedList includeTitles={true}>
            ...
            <>
              <Text bold>Register Worker VM</Text>
              <Text>
                For Windows worker, extract the WORKER_ID, WORKER_SECRET, PROJECT_ID, and TEMPORAL_TLS_CA_CERT values from the provided commands and enter them when prompted during installation.
              </Text>
            </>
          </NumberedList>
...
export TEMPORAL_TLS_CA_CERT=${gatewayCACertificate}
        ...
        <Card>
          <CardContent>
            <Layout.Grid rowGap="sm">
              ...
              <Layout.GridItem lg={12}>
                <Text className="text-base font-semibold mb-2">TEMPORAL_TLS_CA_CERT</Text>
                <CodeSnippet
                  highLightLanguage={"text"}

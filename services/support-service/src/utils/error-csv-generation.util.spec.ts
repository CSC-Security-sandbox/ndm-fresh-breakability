...
import {
  ...
  formatDateTime,
} from './error-csv-generation.util';
...
describe('error-csv-generation.util', () => {
  ...
  describe('groupDataByProjectAndDate', () => {
    ...
    it('should handle invalid dates gracefully', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        'Invalid date found for item 1: invalid-date',
      );
  ...
  describe('formatDateTime', () => {
    ...
    it('should handle Date objects with different times', () => {
      const testCases = [
        {
          input: new Date('2025-01-15T00:00:00Z'),
          expected: '2025-01-15 00:00:00',
        },
        {
          input: new Date('2025-01-15T12:30:45Z'),
          expected: '2025-01-15 12:30:45',
        },
        {
          input: new Date('2025-01-15T23:59:59Z'),
          expected: '2025-01-15 23:59:59',
        },
      ];
    ...
    it('should throw error for non-ISO string formats', () => {
      ...
      invalidFormats.forEach((format) => {
        expect(() => formatDateTime(format)).toThrow(

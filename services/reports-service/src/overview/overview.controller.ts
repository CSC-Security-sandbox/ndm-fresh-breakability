...
export class OverviewController {
  ...
  @ApiResponse({
    status: 200,
    description: "Returns the storage and job overview details.",
  })
  @ApiResponse({
    status: 404,
    description: "Required parameters are missing in the request.",
  })
  ...
  async getStorageAndJobsOverview(
    ...
    return await this.overviewService.getStorageAndJobsOverview(
      projectId,
      configId,
      jobConfigId
    );

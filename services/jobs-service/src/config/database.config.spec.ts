...
describe('TypeORM Config', () => {
  ...
  it('should return the correct TypeORM configuration', () => {
    ...
    const expectedConfig: DataSourceOptions = {
      ...
      dropSchema: false,
      logging: false,
      entities: [WorkerEntity, ConfigEntity, InventoryEntity, FileServerEntity, VolumeEntity, ProjectEntity, JobConfigEntity, JobIdMappingEntity, JobRunEntity, TaskEntity, OperationsEntity, WorkerJobRunMap],
      migrations: []
    };

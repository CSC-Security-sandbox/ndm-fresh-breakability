...
export class WorkersController {
  ...
  @ApiOperation({
    summary: 'Get a paginated list of Workers',
    description:
      'Returns a list of Workers based on the provided pagination parameters.',
  })
  @ApiOkResponse({
    description: 'The list of Workers has been retrieved successfully.',
    type: WorkerStatusPageResponseDto,
  })
  @ApiBadRequestResponse({
  ...
  async getWorkers(
    ...
    workerStatusPageDto: WorkersStatusPageDto,
  ) {
  ...
  @ApiResponse({
    status: 200,
    description: 'Worker job run status updated successfully.',
  })
  ...
  async updateWorkerJobRunStatus(
    ...
    return this.workersService.updateWorkerJobRunStatus(
      workerId,
      jobrunId,
      active,
    );
